...
export default class Scene8 extends HW4Scene {
    ...
    public override startScene() {
        ...
        id = this.initializeBoss(11, 10, 10, 200, 200, 1, bossAttackSpeed, 50, 35, "boss");
        tm = new Timer(bossAttackSpeed-bossAttackDelayDiff, this.handleBossAttack);
        this.bossTimers.push({id: id, timer: tm});

        bossAttackSpeed = 1750;
        bossAttackDelayDiff = 250; 
        id = this.initializeBoss(11, 10, 10, 300, 200, 1, bossAttackSpeed, 50, 35, "boss");
        tm = new Timer(bossAttackSpeed-bossAttackDelayDiff, this.handleBossAttack);
        this.bossTimers.push({id: id, timer: tm});
    ...
    protected handleSceneEndWin (): void {
        ...
        this.emitter.fireEvent(GameEventType.STOP_SOUND, {key: "bossMusic1"});
        this.sceneManager.changeToScene(Scene9);
    }
    ...
    protected initializeBoss(speed: number, health: number, maxHealth: number, bossX: number, bossY: number,
        ...
        let BossHealthBar = new BossHealthbarHUD(this,boss, "primary", {size: boss.size.clone().scaled(2, 1/2), offset: boss.size.clone().scaled(0, -1/2)},"Giovanni Scripelli");
